...
const Brand = () => (
    <>
        <Helmet>
            <meta name = "description" content = "Get potential customers to spend money in your brand. Automate repetitive or recurring actions to save you time and energy" />
            <link rel = "canonical" href = "/" />
        </Helmet>
        <div className = "brand">
            <div className = "brand-image-container animated-background">
                <img
                    alt = "Brand"
                    src = {Image}
                    loading  = {"lazy"}
